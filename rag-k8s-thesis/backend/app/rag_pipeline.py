...
class RagPipeline:
    ...
    def _ollama_options(self, *, max_tokens_override: int | None = None) -> dict[str, Any]:
    ...
    def _complete_ollama(self, prompt: str, *, max_tokens_override: int | None = None) -> str:
        payload: dict[str, Any] = {
            ...
            "prompt": prompt,
            "stream": False,
            "options": self._ollama_options(max_tokens_override=max_tokens_override),
        }
        resp = requests.post(
    ...
    def warmup_ollama(self) -> None:
        """Prime Ollama weights for the configured model (short generation)."""
        try:
    ...
    def query(self, user_query: str) -> dict[str, Any]:
        ...
        answer = self._complete_ollama(prompt)
